...
const TaskService = {
    ...
    completeTask(currentState, taskId, remark = "") {
        ...
        const pointsAwarded = xpAwarded * POINTS_PER_XP;
...
function renderTaskBoard() {
    ...
    elements.taskBoardHint.textContent = isCurrentDaySelected
        ? "Tasks are grouped by category. Complete today's scheduled tasks to earn XP, points, and logbook entries."
...
function renderTaskCard(task, isCurrentDaySelected, todayKey) {
    ...
    if (isCurrentDaySelected && completedToday) {
        ...
        statusCopy = task.repeatType === "weekly"
            ? "Worth 10 XP and 10 points, with a 20 XP and point bonus when the weekly target is reached."
            : "Worth 10 XP and 10 points on completion.";
    }
